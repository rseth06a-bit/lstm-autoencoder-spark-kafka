...
class PreprocessorConfig:
    ...
    sequence_length: int = SAMPLES_PER_WEEK  # 336 (one week), single predictive window
    train_weeks: int = 9 #duration for model training
    val_weeks: int = 3     # For early stopping AND error distribution fitting, used for validation set
    ...
    min_anomaly_overlap: float = 0.10  # Minimum overlap fraction to label week anomalous - if anomalous behavior is 10% of the week, the whole week becomes anomalous
